...
export function createMemoryDiagnostics({
  ...
  return {
    ...
    registries: {
      ...
      classicTurnsWithTrace: finiteNumber(activeTurnCorrelation?.turnsWithTrace),
      classicTurnsWithRequestTrace: finiteNumber(activeTurnCorrelation?.turnsWithRequestTrace),
      classicTurnsWithSessionAliases: finiteNumber(activeTurnCorrelation?.turnsWithSessionAliases),
      classicTransportFinishedTurns: finiteNumber(activeTurnCorrelation?.transportFinishedTurns),
      classicPlaceholderOnlyTurns: finiteNumber(activeTurnCorrelation?.placeholderOnlyTurns),
      classicActiveTurnWaitersWithTrace: finiteNumber(activeTurnCorrelation?.waitersWithTrace),
      classicActiveTurnWaitersWithRequestTrace: finiteNumber(activeTurnCorrelation?.waitersWithRequestTrace),
      classicActiveTurnWaitersWithSessionAliases: finiteNumber(activeTurnCorrelation?.waitersWithSessionAliases),
    ...
    features: {
      ...
      conversationProgressLivenessEnabled: config?.conversationProgressLivenessEnabled !== false,
      conversationProgressReportSeconds: finiteNumber(config?.conversationProgressReportSeconds ?? config?.conversationProgressReminderSeconds),
      conversationProgressRescueSeconds: finiteNumber(config?.conversationProgressContinueSeconds),
