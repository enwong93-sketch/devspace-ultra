...
const BUILTIN_ROUTES = [
  ...
  },
  {
    ...
    description: "Start or reuse a separate Blender process, loopback port, and isolated MCP connection for one conversation.",
    ...
    priority: 34,
    nextAction: { tool: "blender_runtime", arguments: { action: "list" }, then: "Reuse a matching owned runtime; when work is already open, adopt the one unclaimed existing runtime without restarting it. Start a new runtime only for a future project, then call blender_mcp." },
  },
  {
