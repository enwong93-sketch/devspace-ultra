...
iwr https://raw.githubusercontent.com/enwong93-sketch/devspace-ultra/v0.5.3/install-skill.ps1 -OutFile $p
& $p
```
...
```powershell
$p=Join-Path $env:TEMP 'devspace-ultra-install.ps1'; iwr https://raw.githubusercontent.com/enwong93-sketch/devspace-ultra/v0.5.3/install.ps1 -OutFile $p; & $p -Network DuckDNS
```
...
iwr https://raw.githubusercontent.com/enwong93-sketch/devspace-ultra/v0.5.3/install.ps1 -OutFile $p
& $p `
  -Network Cloudflare `
