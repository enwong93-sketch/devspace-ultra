...
iwr https://raw.githubusercontent.com/enwong93-sketch/devspace-ultra/v0.5.6/install-skill.ps1 -OutFile $p
& $p
```
...
iwr https://raw.githubusercontent.com/enwong93-sketch/devspace-ultra/v0.5.6/install.ps1 -OutFile $p
& $p `
  -Network Cloudflare `
