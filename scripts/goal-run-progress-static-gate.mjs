...
assert.match(server, /conversationAuthorityReady, goalRunProgress, requestConversationContext, progressClaimRegistry, conversationStartClaimRegistry, resolveProgressClaimPage, resolveStartClaimPage, interactiveProgressGate, conversationProgressLiveness\)/,
