...
console.log(JSON.stringify({ ok: true, gate: "goal-run-progress-static", backendOwned: true, nativeTurnCreatesWaitingCard: true, actualHandlerBoundaries: true, pollingExcluded: true, boundedPersistence: true, heartbeatIndependentOfClassicUi: true }));
